...
Transaction.prototype.toBufferWriter = function(writer) {
  if (!this.fOverwintered) {
    ...
    // For example, var header = 0x(C|8)0000000 | this.version; returns -(3|7)fffffff.
    var header = (this.fInstant ? 0xC0000000 : 0x80000000) + this.version;
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  this.fInstant = ((header >>> 30) == 1);
  if (this.fOverwintered == true) {
    this.version = header & 0x3fffffff;
  } else {
    this.version = header;
  }
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  if (this.fOverwintered) {
    ...
    this.fInstant = transaction.fInstant;
  }
